...
def filter_vis(layer_name):
    if template == "vgg16":
        ...
        # layer_name = raw_input('layer to display (see above for choices): ')
        ...
        filter_index = int(raw_input('Insert filter index to view (0-%d): ' % (nb_filters - 1)))
        ...
        print('Saving image result to disk...')
        imsave('layer_%s_filter_%d.png' % (layer_name, filter_index), img)

        print('Showing img on plot...')
        imshow(img)
